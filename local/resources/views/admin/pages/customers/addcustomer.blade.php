            ...
            <div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
                <div class="portlet box green">
                    ...
                    <div  class="portlet-body form">
                            <form method="post" name="settingform"   id="settingform" class="horizontal-form" action="{{url('customers/create')}}" files="true" enctype="multipart/form-data">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="tab_1">
                                    <div class=" input-icon right">       
                                      <input type="text" id="ar_name" name="ar_name" value="" class="form-control " >
                                    </div>
                                  </div>

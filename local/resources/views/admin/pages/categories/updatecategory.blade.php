            ...
            <div class="col-md-12">
                <div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
                    ...
                    <div  class="portlet-body form">
                       <form method="post" name="settingform" action="{{url('categories/update')}}"  id="settingform" class="horizontal-form">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade active in" id="tab_1">
                                                        ...
                                                        <div class=" input-icon right">       
                                                            ...
                                                            <input type="text" id="name_ar" name="name_ar" value="{{$category->cat_trans('ar')->name}}" class="form-control required" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="tab-pane fade active in" id="tab_11">
                                        <?php $main=$category->maincat; ?>
                                        <select class="form-control" name="parent">
                                            @if($main==null)
                                        <option value=""></option>   
                                        @else
                                        <option value="{{$category->parent_id}}">{{$main->cat_trans('ar')->name}}</option>   
                                        @endif
                          <?php   $space='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; ?>
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="col-md-9">
                                      <select multiple="multiple" class="multi-select" id="my_multi_select1" name="attributes[]">
                                          ...
                                          @foreach($category->attribute as $attrib)
                                                        ...
                                                        <label class="control-label">مفتاح ال Meta</label>
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane fade active in" id="tab_3">
                                                                    <div class=" input-icon right">       
                                                                        <input type="text" id="metakeywords_ar" name="metakeywords_ar" value="{{$category->cat_trans('ar')->meta_keywords}}" class="form-control required" >
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane fade active in" id="tab_4">
                                                                    <div class=" input-icon right">       
                                                                        <input type="text" id="metatitle_ar" name="metatitle_ar" value="{{$category->cat_trans('ar')->metatitle}}" class="form-control " >
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane fade active in" id="tab_5">
                                                                    <div class=" input-icon right">       
                                                                        <textarea id="metadesc_ar" name="metadesc_ar" value="{{$category->cat_trans('ar')->meta_desc}}" class="form-control " ></textarea>
                                                                    </div>
                                                                </div>

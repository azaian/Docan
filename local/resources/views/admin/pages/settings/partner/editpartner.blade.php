            ...
            <div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
                <div class="portlet box green">
                    ...
                    <div  class="portlet-body form">
                            <form method="post" name="settingform"   id="settingform" class="horizontal-form" action="{{url('partner/editpartner/' . $old_partner->id)}}" files="true" enctype="multipart/form-data">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="tab_1">
                                    <div class=" input-icon right">
                                      <input type="text" value="{{$old_partner->name}}" id="name" name="name" value="" class="form-control " >
                                    </div>
                                  </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label bold">التليفون</label>
                            <div class="input-icon right">
                              <input type="text" class="form-control"  value="{{$old_partner->phone}}" name="phone" id="phone">
                            </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label bold"> الايميل</label>
                            <div class="input-icon right">
                              <input type="email"  class="form-control" value="{{$old_partner->email}}" name="email" id="email">
                            </div>
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label bold"> الموقع الإلكترونى</label>
                            <div class="input-icon right">
                              <input type="text" class="form-control" value="{{$old_partner->website}}" name="website" id="website">
                            </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label bold">الفيسبوك</label>
                            <div class="input-icon right">
                              <input type="text" class="form-control" value="{{$old_partner->facebook}}" name="facebook" id="facebook">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label bold">التفاصيل</label>
                            <div class="input-icon right">
                              <input type="text" class="form-control" value="{{$old_partner->details}}" name="details" >
                            </div>
                        </div>
                      </div>
                    </div>

...
<ul class="page-breadcrumb">
 ...
 <li>
   <a href="#">تقارير العملاء </a>
      <i class="fa fa-angle-left"></i> 
 </li> 
 <li>
   <a href="#"> اجمالى العملاء </a>
...
<div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-eye"></i>عرض اجمالى العملاء </div>
                                    ...
                                    <form method="get" id="search_form">
                                        ...
                                        <div class="row">    
                                            <div class="col-md-4 col-sm-4">
                                                ...
                                                <button type="button" class="btn green " id="filterBtn">
...
function formFilter(){
  ...
  $.ajax({
     url: '{{ url("reports/searchagent") }}' ,
    type: 'get',
    data: data,
    success: function(data){        
      $("#search_tabel2").html(data);
      $("#sample_1").dataTable(data);
